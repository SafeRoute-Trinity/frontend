...
const PUBLIC_ENDPOINTS: CoreEndpoints = {
  ...
  highRiskAlertUrl: 'https://saferoutemap.duckdns.org/api/high_risk_alert',
  routeCalculateUrl: 'https://saferoutemap.duckdns.org/v1/routes/calculate',
...
const profileDefaults = PUBLIC_ENDPOINTS;
...
export const coreEndpoints: CoreEndpoints = {
  ...
  sosBaseUrl: pickValue(process.env.EXPO_PUBLIC_SOS_API_URL, profileDefaults.sosBaseUrl),
  ...
  highRiskAlertUrl: pickValue(
    process.env.EXPO_PUBLIC_HIGH_RISK_ALERT_URL,
    profileDefaults.highRiskAlertUrl
  ),
  routeCalculateUrl: pickValue(
