...
const checkHttpService = async (service: ServiceDefinition): Promise<ServiceStatus> => {
...
const formatJsonResponse = (body: string): string => {
  try {
...
const formatSummary = (statuses: Record<string, ServiceStatus>, isChecking: boolean) => {
  if (isChecking) {
